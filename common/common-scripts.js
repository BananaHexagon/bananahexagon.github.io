...
const common_1 = '<div id="menu_shadow" class="left_off"></div><div class="left_off" id="left_menu"><div id="left_menu_links"><h2>リンク</h2><p><a href="/index.html">トップページ</a></p><p><a href="/article/">ブログ</a></p><p><a href="/creations/sludgetale/">Sludgetale</a></p><p><a href="https://discord.gg/3JZvH8fqzJ">Discordサーバー(外部リンク)</a></p></div><div id="left_menu_credits"><h2>クレジット</h2><p><a href="https://fonts.google.com/noto/specimen/Noto+Sans+JP">Noto Sans Japanese</a> by Google</p></div><header><label class="hamburger" id="hamburger_left"><div></div><div></div><div></div><input type="checkbox" id="left_switch" onclick="left_Click()" for="hamburger_left"></label></header>'
