...
const common_1 = '<div id="menu_shadow" class="left_off"></div><div class="left_off" id="left_menu"><h2>クレジット</h2><p><a href="https://fonts.google.com/noto/specimen/Noto+Sans+JP">Noto Sans Japanese</a> by Google</p><h2>リンク</h2><p><a href="/index.html">トップページ</a></p><p><a href="/article/">記事一覧</a></p></div><header><label class="hamburger" id="hamburger_left"><div></div><div></div><div></div><input type="checkbox" id="left_switch" onclick="left_Click()" for="hamburger_left"></label><label class="hamburger" id="hamburger_right"><div></div><div></div><div></div><input type="checkbox" id="right_switch" onclick="right_Click()" for="hamburger_right"></label></header>'
