...
let commonout = "<div id=\"menushadow\" class=\"sidemenu_off\"></div><div id=\"sidemenu\" class=\"sidemenu_off\"><h2>クレジット</h2><p><a href=\"https://fonts.google.com/noto/specimen/Noto+Sans+JP\">Noto Sans Japanese</a> by Google</p><h2>リンク</h2><a href=\"/index.html\">トップページ</a><br><a href=\"/article\">記事一覧</a></div><header><label class=\"hamburger\" id=\"hamburger1\"><div></div><div></div><div></div><input type=\"checkbox\" id=\"sideswitch\" onclick=\"buttonClick()\" for=\"hamburger1\"></label></header>"
