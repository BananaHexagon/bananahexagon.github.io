...
let commonout = "<div id=\"menushadow\" class=\"sidemenu_off\"></div><div id=\"sidemenu\" class=\"sidemenu_off\"><h1>クレジット</h1><p><a href=\"https://fonts.google.com/noto/specimen/Noto+Sans+JP\">Noto Sans Japanese</a> by Google</p></div><header><label class=\"hamburger\" id=\"hamburger1\"><div></div><div></div><div></div><input type=\"checkbox\" id=\"sideswitch\" onclick=\"buttonClick()\" for=\"hamburger1\"></label></header>"
